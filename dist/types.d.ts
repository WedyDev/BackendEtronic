...
export interface ClientToServerEvents {
    'user:join': (username: string, roomCode: string, callback: (user: User | {
        error: string;
    }) => void) => void;
    ...
    'question:add': (text: string, callback: (response: {
        error?: string;
    }) => void) => void;
    ...
    'question:voteSkip': (questionId: string, callback: (response: {
        error?: string;
        skipped?: boolean;
    }) => void) => void;
}
